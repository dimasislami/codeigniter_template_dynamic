         ...
         <nav class="navbar navbar-static-top" role="navigation">
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown user user-menu">
                    ...
                    <span class="hidden-xs">Hello Dimas Islami</span>
                    </a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header" style="text-align:center">
                            <img src="<?php echo base_url().'/assets/uploads/icons/men.png' ?>" alt='User Image' class="img-circle">  
                              <p style="color:#fff">
                              Dimas Islami <br>
                              <small>Member since  2016-10-20</small>
                            </p>
                        </li>
                        <li class="user-footer">
                            <div class="pull-right">
                                <a href="#" class="btn btn-default btn-flat"><i class="fa fa-power-off"> Log out</i></a>
                            </div>
                        </li>
                    </ul>
                </li>
